#############################################################################
# Makefile for building: rsl
# Generated by qmake (3.1) (Qt 5.15.10)
# Project:  rsl.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile rsl.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = rsl1.0.0
DISTDIR = /home/lumine/Documenti/cpp-progetto-pao/codice/obj/rsl1.0.0
LINK          = g++
...
SOURCES       = src/main.cpp \
		src/OperatoreBinario.cpp \
		src/qt.cpp \
		src/Sequente.cpp \
		src/Shell.cpp 
OBJECTS       = obj/main.o \
		obj/OperatoreBinario.o \
		obj/qt.o \
		obj/Sequente.o \
		obj/Shell.o
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		rsl.pro src/OperatoreBinario.hpp \
		src/qt.hpp \
		src/Sequente.hpp \
		src/Shell.hpp src/main.cpp \
		src/OperatoreBinario.cpp \
		src/qt.cpp \
		src/Sequente.cpp \
		src/Shell.cpp
...
Makefile: rsl.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/OperatoreBinario.hpp src/qt.hpp src/Sequente.hpp src/Shell.hpp $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/OperatoreBinario.cpp src/qt.cpp src/Sequente.cpp src/Shell.cpp $(DISTDIR)/
...
obj/main.o: src/main.cpp src/OperatoreBinario.hpp \
		src/Sequente.hpp \
		src/Shell.hpp \
		src/qt.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/main.o src/main.cpp

obj/OperatoreBinario.o: src/OperatoreBinario.cpp src/OperatoreBinario.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/OperatoreBinario.o src/OperatoreBinario.cpp

obj/qt.o: src/qt.cpp src/Shell.hpp \
		src/OperatoreBinario.hpp \
		src/Sequente.hpp \
		src/qt.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/qt.o src/qt.cpp

obj/Sequente.o: src/Sequente.cpp src/OperatoreBinario.hpp \
		src/Sequente.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/Sequente.o src/Sequente.cpp

obj/Shell.o: src/Shell.cpp src/OperatoreBinario.hpp \
		src/Sequente.hpp \
		src/Shell.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/Shell.o src/Shell.cpp
